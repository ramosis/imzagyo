const portfoyVerileri = {
    "bogaz-villa": {
        ...
        ozellikler: ["Akıllı Ev Sistemi", "Özel Isıtmalı Havuz", "4 Araçlık Otopark", "VRF İklimlendirme"],
        danisman: {
            isim: "Selim Yıldırım",
            unvan: "Danışman",
            resim: "https://images.unsplash.com/photo-1560250097-0b93528c311a?auto=format&fit=crop&w=300&q=80"
        }
    },
    // ... rest of the data remains the same manually copied to ensure no loss
    "ekolojik-ev": {
        ...
        ozellikler: ["Güneş Enerji Sistemi", "Doğal Yüzme Göleti", "Yağmur Suyu Hasadı", "Şömine & Akıllı Ev"],
        danisman: {
            isim: "Burak Kaya",
            unvan: "Doğa Koleksiyonu Direktörü",
            resim: "https://images.unsplash.com/photo-1519085360753-af0119f7cbe7?auto=format&fit=crop&w=300&q=80"
        }
    },
    "cam-oda-penthouse": {
        ...
        ozellikler: ["360 Derece Teras", "Rezidans Hizmetleri", "Özel Asansör", "Gaggenau Mutfak"],
        danisman: {
            isim: "Cemil Arslan",
            unvan: "Modern Koleksiyon Direktörü",
            resim: "https://images.unsplash.com/photo-1472099645785-5658abf4ff4e?auto=format&fit=crop&w=300&q=80"
        }
    }
};
