 ...
 * Converted to browser-compatible format (IIFE) to avoid "Unexpected token export" errors.
 */
...
(function(window) {
    ...
    // Export to window
    window.IdentityHelpers = IdentityHelpers;
    window.AuditHelpers = AuditHelpers;
